...
describe('Entities reducer tests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          ...
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_BLOODPRESSURE),
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_BLOODPRESSURE),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_BLOODPRESSURE actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_BLOODPRESSURE),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_BLOODPRESSURE),
          payload: resolvedObject,
        },
      ];
