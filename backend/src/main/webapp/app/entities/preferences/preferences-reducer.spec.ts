...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_PREFERENCES),
          REQUEST(ACTION_TYPES.UPDATE_PREFERENCES),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PREFERENCES),
          REQUEST(ACTION_TYPES.DELETE_PREFERENCES),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_PREFERENCES),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_PREFERENCES actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_PREFERENCES),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_PREFERENCES),
          payload: resolvedObject,
        },
      ];
