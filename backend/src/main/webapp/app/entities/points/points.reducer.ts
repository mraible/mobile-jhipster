...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_POINTS: 'points/PARTIAL_UPDATE_POINTS',
...
export default (state: PointsState = initialState, action): PointsState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_POINTS):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_POINTS):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_POINTS):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IPoints> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_POINTS,
