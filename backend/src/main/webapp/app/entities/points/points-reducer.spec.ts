...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_POINTS),
          REQUEST(ACTION_TYPES.UPDATE_POINTS),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_POINTS),
          REQUEST(ACTION_TYPES.DELETE_POINTS),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_POINTS),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_POINTS actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_POINTS),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_POINTS),
          payload: resolvedObject,
        },
      ];
