...
class PointEntityScreen extends React.PureComponent {
  ...
  *************************************************************/
  ...
  renderEmpty = () => <AlertMessage title="No Points Found" show={!this.props.fetching} />
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    if (nextProps.points) {
      return {
        done: nextProps.points.length < prevState.size,
        dataObjects: [...prevState.dataObjects, ...nextProps.points],
      }
    }
    return null
  }
